...
class MiPolygon : public QGraphicsPolygonItem, public SolidObject
{
...
protected:
    MiPolygon(QPolygonF pa, uint thickness, QColor pen_color, QColor fill_color,
...
public:
    ...
    int type(void) const;
    QString getTypeName(void) const { return "solid_polygon" ; }
